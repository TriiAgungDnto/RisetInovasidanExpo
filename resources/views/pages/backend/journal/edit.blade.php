                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control form-control-sm">
                                        ...
                                        <option value="nasional" {{ old('type') == 'nasional' ? 'selected' : '' }}
                                            {{ $journal->type == 'nasional' ? 'selected' : '' }}>Nasional
                                        </option>
                                        <option value="internasional"
                                            {{ old('type') == 'internasional' ? 'selected' : '' }}
                                            {{ $journal->type == 'internasional' ? 'selected' : '' }}>Internasional
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-body">
                                    ...
                                    <select name="member" id="member" class="form-control form-control-sm">
                                        ...
                                        @foreach ($members as $member)
                                            <option value="{{ $member->id }}"
                                                ...
                                                {{ $journal->member_id == $member->id ? 'selected' : '' }}>
                                                {{ $member->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="major" id="major" class="form-control form-control-sm">
                                        ...
                                        @foreach ($majors as $major)
                                            <option value="{{ $major->id }}"
                                                ...
                                                {{ $journal->major_id == $major->id ? 'selected' : '' }}>
                                                {{ $major->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="team" name="teams[]"
                                        ...
                                        value="{{ old('teams.0') ?? $journal->team }}" data-role="tagsinput" required />
                                    @error('teams')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
