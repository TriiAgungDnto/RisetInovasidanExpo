                        ...
                        <table id="books-table" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $book->isbn }}</td>
                                    <td>
                                        <a href="{{ asset('file/book/'. $book->file) }}">
                                            <button class="btn btn-xs btn-primary"><i
                                                    class="fas fa-download"></i></button>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{ route('book.edit', $book) }}"><button class="btn btn-info btn-xs"><i
                                                    class="fa fa-edit"></i></button></a>
                                        <button class="btn btn-danger btn-xs" id="btn-delete" data-toggle="modal"
                                            data-target="#modal-delete" data-url="{{ route('book.destroy', $book) }}"
                                            data-title="{{ $book->title }}"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                                @empty
                                <tr>
