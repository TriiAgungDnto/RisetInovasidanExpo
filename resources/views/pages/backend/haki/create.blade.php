                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="register_number"
                                    name="register_number" value="{{ old('register_number') }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control form-control-sm">
                                    ...
                                    <option value="hak cipta" {{ old('type')=='hak cipta' ? 'selected' : '' }}>hak
                                        cipta
                                    </option>
                                    <option value="paten" {{ old('type')=='paten' ? 'selected' : '' }}>paten</option>
                                    <option value="merk" {{ old('type')=='merk' ? 'selected' : '' }}>merk</option>
                                </select>
                            </div>
                            <div class="form-group">
