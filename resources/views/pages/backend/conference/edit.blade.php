...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Conference</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('conference.update', $conference) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <!-- left column -->
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="type" id="type">
                                        ...
                                        <option value="internasional"
                                            {{ old('type') == 'internasional' ? 'selected' : '' }}
                                            {{ $conference->type == 'internasional' ? 'selected' : '' }}>Internasional
                                        </option>
                                        <option value="nasional" {{ old('type') == 'nasional' ? 'selected' : '' }}
                                            {{ $conference->type == 'nasional' ? 'selected' : '' }}>
                                            Nasional</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="organizer"
                                        name="organizer" value="{{ old('organizer') ?? $conference->organizer }}">
                                </div>

                                <div class="form-group">
                                    <label for="location">Lokasi <small>*</small></label>
                                    <input type="text" class="form-control form-control-sm" id="location"
                                        name="location" value="{{ old('location') ?? $conference->location }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="isbn" name="isbn"
                                        value="{{ old('isbn') ?? $conference->isbn }}">
                                </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <select name="member" id="member" class="form-control form-control-sm">
                                        ...
                                        @foreach ($members as $member)
                                            <option value="{{ $member->id }}"
                                                ...
                                                {{ $conference->member_id == $member->id ? 'selected' : '' }}>
                                                {{ $member->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="major" id="major" class="form-control form-control-sm">
                                        ...
                                        @foreach ($majors as $major)
                                            <option value="{{ $major->id }}"
                                                ...
                                                {{ $conference->major_id == $major->id ? 'selected' : '' }}>
                                                {{ $major->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="team" name="teams[]"
                                        ...
                                        value="{{ old('teams.0') ?? $conference->team }}" data-role="tagsinput"
                                        required />
                                    @error('teams')
                                        <div class="invalid-feedback">
                                            {{ $message }}
